...
SECRET_KEY = 'django-insecure-6z-#2oumcybaa0vvf$-d9wt2+$&idw-3@7+*&b06n!-og6xt$h'
...
MIDDLEWARE = [
    ...
    'LDA.middleware.RedirectAuthenticatedUserMiddleware',
]
...
# Tambahkan konfigurasi crispy template pack
